...
public class CriptoHelper {
	...
	public CriptoHelper() throws NoSuchAlgorithmException, NoSuchPaddingException {
...
//		System.out.println("decript"+_out);
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String SHA256NextBus () throws NoSuchAlgorithmException, UnsupportedEncodingException {

//		int GURUGAMAN_KEY = BuildConfig.GURUGAMAN_KEY;
		int GURUGAMAN_KEY = 15;
		String resultStr,text="Aug"+GURUGAMAN_KEY+"AES#Dimts@Gurugaman";
		int length=32; //32 bytes = 256 bit
	...
	// Conductor Login Encryption Data
